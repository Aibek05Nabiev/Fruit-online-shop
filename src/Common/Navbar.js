                    ...
                    <nav className="navbar navbar-light bg-white navbar-expand-xl">
                        ...
                        <div className="collapse navbar-collapse bg-white" id="navbarCollapse">
                            <div className="navbar-nav mx-auto">
                                <Link to="/"  className="nav-item nav-link active">Үй</Link>
                                <Link to="/shop"  className="nav-item nav-link">Дүкөн</Link>
                                <Link to="/shop-details" className="nav-item nav-link">Дүкөндүн чоо-жайы</Link>
                                <div className="nav-item dropdown">
                                    <Link   className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Категория</Link>
                                    <div className="dropdown-menu m-0 bg-secondary rounded-0">
                                        <Link className="dropdown-item">Жашылчалар</Link>
                                        <Link className="dropdown-item">Fruit</Link>
                                        <Link className="dropdown-item">Нан</Link>
                                        <Link className="dropdown-item">Эт</Link>
                                    </div>
                                </div>
                                <Link to="/contact" className="nav-item nav-link">Байланыш</Link>
                            </div>
