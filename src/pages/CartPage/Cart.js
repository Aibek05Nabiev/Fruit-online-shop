...
export default function Cart() {
  ...
  const emptyCartMsg = (
    <h4 className="container text-center p-4">Арабаңыз бош</h4>
  );

  return (
    <>
      <div className="container-fluid page-header py-5">
        <h1 className="text-center text-white display-6">Араба</h1>
        <ol className="breadcrumb justify-content-center mb-0">
          <Link sat to="/" className="breadcrumb-item">
            <a href="#">Үй</a>
          </Link>
          <li className="breadcrumb-item active text-white">Араба</li>
        </ol>
      </div>
          ...
          <div className="container py-5">
            <div className="table-responsive">
              <table className="table">
                <thead>
                  <tr>
                    <th scope="col">Продукциялар</th>
                    <th scope="col">аты</th>
                    <th scope="col">Баасы</th>
                    <th scope="col">Саны</th>
                    <th scope="col">Бардыгы</th>
              ...
              <div className="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                <div className="bg-light rounded">
                  <div className="p-4">
                    ...
                    Араба <span className="fw-normal">Бардыгы</span>
                    </h1>
                    <div className="d-flex justify-content-between mb-4">
                      <h5 className="mb-0 me-4">Аралык сумма:</h5>
                      <p className="mb-0">${totalAmount}</p>
                    </div>
                    <div className="d-flex justify-content-between">
                      <h5 className="mb-0 me-4">Жеткирүү</h5>
                      <div>
                        <p className="mb-0">Жалгыз тариф: $ {deliverCharge}</p>
                      </div>
                    </div>
                  </div>
                  <div className="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                    <h5 className="mb-0 ps-4 me-4">Бардыгы</h5>
